...
- [Kotlin Crash Course YT](https://www.youtube.com/watch?v=dzUc9vrsldM&pp=ygUTa290bGluIGNyYXNoIGNvdXJzZQ%3D%3D)

# Future Work

-Save and load expenses from a file
-Add input validation for better error handling
-Allow filtering by date or category
-Improve the console interface and formatting